...
export default function UniformCategoryPage() {
  ...
  useEffect(() => {
    const fetchUniforms = async () => {
      const res = await fetch('/api/products/jersey');
  ...
  return (
    <div className="min-h-screen  text-white flex justify-center items-center px-4 py-10">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10 w-full max-w-7xl">
        ...
        <div className="flex flex-col justify-center items-center text-center w-full lg:w-2/3 space-y-6 lg:items-start lg:text-left">
          <div className='mb-20'>
            <h1 className="text-4xl font-bold mb-4">Find Your Jersey</h1>
            <p className="text-gray-400 text-lg">Select your Institution</p>
          </div>
        ...
        <div className="w-full lg:w-1/3 flex flex-col items-center mt-6 lg:mt-0 lg:mr-8">
          {filtered.length > 0 ? (
            ...
            <div className="text-gray-400 mt-10 text-lg">No Jersey found</div>
          )}
        </div>
      </div>
    </div>
